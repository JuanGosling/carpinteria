        ...
        <div class="inicio">
            ...
            <form method="post" id="formulario" >
                ...
                <div class="cajadetexto">
                    ...
                    <img src="../register/mail.png" class="icono">
                ...
                <div class="cajadetexto">
                    ...
                    <img src="../register/user.png" class="icono">
                ...
                <div class="cajadetexto">
                    ...
                    <img src="../register/cerrado.png" class="icono" id="ojo" style="cursor: pointer;">
                ...
                <div class="cajadetexto">
                    ...
                    <img src="../register/cerrado.png" class="icono" id="ojo1" style="cursor: pointer;">
        ...
        <script>
            ...
            ojo.onclick = function(){
                ...
                if(contraseña.type == "password"){
                    ...
                    ojo.src = "../register/abierto.png";
                }

                else{
                    contraseña.type = "password";
                    ojo.src = "../register/cerrado.png";
                }
            ...
            ojo1.onclick = function(){
                ...
                if(confirmar_contraseña.type == "password"){
                    ...
                    ojo1.src = "../register/abierto.png";
                }

                else{
                    confirmar_contraseña.type = "password";
                    ojo1.src = "../register/cerrado.png";
                }
